...
export default function UserDashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/*
        종합 안전점수 + 절감 비용 (데이터 축적 후 활성화 예정)

        - 종합 안전점수: 100점 기준, 최근 7일간 Level1(-10점), Level2(-3점) 감점 방식
          산출식: 100 - (Level1 건수 × 10) - (Level2 건수 × 3)
          표시 기준: 80+ 안전(초록), 50-79 주의(노랑), 50미만 위험(빨강)

        - 절감 효과: AI 인사이트의 estimated_cost 합산 (예방 가능한 리스크 규모)
          산출식: 인사이트별 (법정 과태료 + 영업정지 일수 × 업종 평균 일매출)
